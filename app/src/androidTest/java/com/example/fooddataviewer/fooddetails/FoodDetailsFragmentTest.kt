...
import com.example.fooddataviewer.di.TestComponent
...
class FoodDetailsFragmentTest {
    ...
    fun viewsTest(){
        ...
        scenario.onFragment { fragment ->
            ...
            // we need idlingRegistry to control the 'background' operations
        ...
        // our assertions here:
        onView(withId(R.id.productNameView)).check(ViewAssertions.matches(withText("Coke Classic")))
